 ...
 */
@WebServlet("/SuprCompte")
public class SuprCompte extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
	// View
    public static String VIEW_PAGES_URL="/WEB-INF/SuprCompte.jsp";
 ...
 // Request attributs
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(error.isEmpty()==true && msgAuthentif == null){
        	statusOk=true;
        	statusMessage="supprimé "+msgAuthentif;
        }
        else{
        	statusOk=false;
        	statusMessage="NOt supprimé "+msgAuthentif;
        }
     // Prepare model to view
        ...
        if(statusOk == true) {
        	...
        	UserManager.getUserManager().deleteUser(email);
